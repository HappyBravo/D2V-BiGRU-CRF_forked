...
class BiLSTMCRF(object):
    ...
    def __init__(self,
        ...
        self._use_d2v = use_d2v
        self._d2v_dim = d2v_dim
    ...
    def build(self):
        ...
        if self._use_d2v:
            d2v_vectors = Input(batch_shape=(None,None,self._d2v_dim), dtype='float32', name='d2v_input')
            inputs.append(d2v_vectors)
            word_embeddings = Concatenate()([word_embeddings, d2v_vectors])
...
class BiLSTMCRFD2V_to_CRF(object):
    """A Keras implementation of BiLSTM-CRF for sequence labeling.
...
class BiLSTMCRFD2V_to_dense(object):
    """A Keras implementation of BiLSTM-CRF for sequence labeling.
    ...
    def build(self):
        ...
        word_embeddings = Dropout(self._dropout)(word_embeddings)
        z = Bidirectional(LSTM(units=self._word_lstm_size, return_sequences=True))(word_embeddings)
        z = Dense(self._fc_dim, activation='tanh')(Concatenate()([z, d2v_vectors]))
        # z = Concatenate()([z, d2v_vectors])
